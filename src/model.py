...
class PerformanceGeneratorDR400(AbstractPerformanceGenerator):
    ...
    def calculate_distances(self, mode, altitude, temperature, mass, herbe: bool = False, wind: float = 0) -> tuple[float, float]:
        ...
        performance_files = glob.glob(f"/Users/sara/Desktop/performance_algorithm/src/data/{folder}/dur/{mode}/*.txt")
        files_herbe = False
        if herbe:
            files_aux = glob.glob(f"/Users/sara/Desktop/performance_algorithm/src/data/{folder}/herbe/{mode}/*.txt")
            if files_aux:
        ...
        if wind != 0:
            ...
            # Read Wind Factors
            dataframe_wind = pd.read_csv(f"/Users/sara/Desktop/performance_algorithm/src/data/{folder}/wind.txt")
...
class PerformanceGeneratorAquila(AbstractPerformanceGenerator):
    ...
    def calculate_distances(self, mode, altitude, temperature, mass, herbe: bool = False, wind: float = 0) -> tuple[float, float]:
        ...
        # Get performance files
        data_altitude = pd.read_csv(f"/Users/sara/Desktop/performance_algorithm/src/data/{folder}/{mode}/altitude.txt")
        data_mass = pd.read_csv(f"/Users/sara/Desktop/performance_algorithm/src/data/{folder}/{mode}/mass.txt")
        data_headwind = pd.read_csv(f"/Users/sara/Desktop/performance_algorithm/src/data/{folder}/{mode}/headwind.txt")
        data_tailwind = pd.read_csv(f"/Users/sara/Desktop/performance_algorithm/src/data/{folder}/{mode}/tailwind.txt")
        data_distances = pd.read_csv(f"/Users/sara/Desktop/performance_algorithm/src/data/{folder}/{mode}/distances.txt")
